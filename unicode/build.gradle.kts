...
kotlin {
    ...
    android {
        namespace = "io.github.aughtone.normalize.unicode"
...
mavenPublishing {
    ...
    coordinates("io.github.aughtone.normalize", "unicode", version.toString())

    pom {
        name = "Aught One Normalize Unicode"
        description = "Frozen Unicode normalization forms - NFC, NFD, NFKC, NFKD - generated from a pinned Unicode release, for the Aught One Normalize suite."
        inceptionYear = "2026"
