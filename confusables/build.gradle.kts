...
kotlin {
    ...
    android {
        namespace = "io.github.aughtone.normalize.confusables"
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "AONormalizeConfusables"
            isStatic = true
            binaryOption(
                "bundleId",
                "io.github.aughtone.normalize.confusables"
            )
            binaryOption(
...
mavenPublishing {
    ...
    coordinates("io.github.aughtone.normalize", "confusables", version.toString())

    pom {
        name = "Aught One Normalize Confusables"
        description = "UTS-39 confusable skeletons for spoof detection, against tables frozen from a pinned Unicode release, for the Aught One Normalize suite."
        inceptionYear = "2026"
