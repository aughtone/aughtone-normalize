...
The wider constraint is [DOC-0001](../specifications/DOC-0001-normalization-suite.md)'s central promise: the policy identity stored beside a derived value must fully determine the canonical bytes. Anything that changes the output and is not part of the identity breaks that.

Feeds from [RAD-0001](../research/RAD-0001-identifier-and-text-normalization.md), which left this open.
