...
The wider constraint is [SPEC-0001](../specifications/SPEC-0001-normalization-suite.md)'s central promise: the policy identity stored beside a derived value must fully determine the canonical bytes. Anything that changes the output and is not part of the identity breaks that.
