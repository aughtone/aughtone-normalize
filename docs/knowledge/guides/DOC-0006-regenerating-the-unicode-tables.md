...
How to move the suite to a new Unicode release, and what to do when the generator refuses. The decision behind all of this — generate from the public data rather than vendor someone's implementation — is [ADR-0002](../decisions/ADR-0002-generating-the-unicode-tables.md).
