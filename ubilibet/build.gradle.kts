...
kotlin {
    ...
    android {
        namespace = "io.github.aughtone.normalize.ubilibet"
...
mavenPublishing {
    ...
    coordinates("io.github.aughtone.normalize", "ubilibet", version.toString())

    pom {
        name = "Aught One Normalize Ubilibet"
        description = "Deterministic, byte-stable hostname and domain normalization under UTS-46, with Punycode, for the Aught One Normalize suite."
        inceptionYear = "2026"
