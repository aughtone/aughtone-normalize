...
kotlin {
    ...
    android {
        namespace = "io.github.aughtone.normalize.quodlibet"
    ...
    listOf(
        ...
        iosTarget.binaries.framework {
            baseName = "AONormalizeQuodlibet"
            isStatic = true
            binaryOption(
                "bundleId",
                "io.github.aughtone.normalize.quodlibet"
            )
            binaryOption(
...
mavenPublishing {
    ...
    coordinates("io.github.aughtone.normalize", "quodlibet", version.toString())

    pom {
        name = "Aught One Normalize Quodlibet"
        description = "Deterministic, byte-stable normalizers that need no lookup table and no external dependency - email today, more to come - for the Aught One Normalize suite."
        inceptionYear = "2026"
