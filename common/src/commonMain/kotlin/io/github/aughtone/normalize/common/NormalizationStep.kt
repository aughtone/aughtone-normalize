 ...
 * configured step travel whole - `username.basic+text.u17+trim+nfc` carries the text policy's rules
...
interface NormalizationStep {
     ...
     * qualifiers. `skeleton.u17` is a group of one; `text.u17+trim+nfc` is a group of three.
     */
